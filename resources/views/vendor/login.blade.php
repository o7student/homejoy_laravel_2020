...
<body class="documentation">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="purple">
            <div class="page-header-image" data-parallax="true" style="background-image: url({{asset('temp/assets/img/full-screen-image-3.jpg')}})">
                <div class="filter"></div>
                <div class="title-container" style="padding: 0em 25em 0em 25em;top:100px;">
                    ...
                    <div class="col-md-4"> -->
                            <div class="card card-user">
                                <div class="card-image">
                                    <img src="{{asset('temp/assets/img/photo-1431578500526-4d9613015464.jpg')}}" alt="...">
                                </div>
                                <div class="card-body">
                                    <div class="author">
                                        <a href="#">
                                            <img class="avatar border-gray" src="{{asset('temp/assets/img/faces/face-3.jpg')}}" alt="...">
