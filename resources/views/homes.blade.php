...
<div class="card" >
  <img class="card-img-top" src="{{asset('distt/images/bb1.jpg')}}" alt="Card image cap">
  <div class="card-body">
...
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  <img class="card-img-top" src="{{asset('distt/images/bb2.jpg')}}" alt="Card image cap">
  <div class="card-body">
...
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  <img class="card-img-top" src="{{asset('distt/images/bb3.jpg')}}" alt="Card image cap">
  <div class="card-body">
...
<div class="card" >
  <img class="card-img-top" src="{{asset('distt/images/bb4.jpg')}}" alt="Card image cap">
  <div class="card-body">
...
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  <img class="card-img-top" src="{{asset('distt/images/bb5.jpg')}}" alt="Card image cap">
  <div class="card-body">
...
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  <img class="card-img-top" src="{{asset('distt/images/bb6.jpg')}}" alt="Card image cap">
  <div class="card-body">
...
<img src="{{asset('distt/images/bb9.jpg')}}" alt="xt" class="img-fluid">
</div>
...
<div class="slideshow-container">
  ...
  <div class="mySlides">
  <img src="{{asset('distt/images/test1.jpg')}}" alt="xyt" class="img-fluid">
    <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h4>
    
  </div>

  <div class="mySlides">
  <img src="{{asset('distt/images/test2.jpg')}}" alt="xyt" class="img-fluid">
    <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h4>
    
  </div>

  <div class="mySlides">
  <img src="{{asset('distt/images/test3.jpg')}}" alt="xyt" class="img-fluid">
    <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h4>
